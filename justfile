...
setup-all: post-install shell security fonts fastfetch kitty yt-dlp virtualization cockpit ides git-setup languages podman-setup
...
setup-laptop-amd: post-install-amd shell security fonts fastfetch kitty yt-dlp virtualization cockpit ides git-setup languages podman-setup
...
setup-media-desktop: post-install-intel shell security fonts fastfetch kitty yt-dlp
